...
store_list = ['포보 홍대점', '카미야', '타코몽', '무쇠김치삼겹 홍대점', '카츠오모이', '금복식당', '우리엄마레시피', '비스트로큐슈', '슈슈', '플레이트946', '비스트로주라', '홍대발바리네', '넙딱집 상수점', '미로식당', '마코토', '상수곱창', '제순식당', '옛맛서울불고기', '야키토리 나루토',
              '후계동', '루시드', '카타코토', '슬로우캘리', '뇽즈', '야키토리 미식서울', '릴린', '원당감자탕 홍대점', '대왕고추장불고기', '델문도', '야키토리 묵', '요코스카쓰나미', '교다이야', '비스트로오라', '지로우라멘', '라멘트럭', '더피자보이즈', '소코아 홍대점', '식스티즈', '바다회사랑', '멕시칸식당베르데']
result = []
...
for store in store_list:
    ...
    try:
        ...
        data['main_menu'] = places['category_name']
        ...
        data['image'] = NULL
        data['user'] = NULL
        data['category'] = places['category_group_name']
